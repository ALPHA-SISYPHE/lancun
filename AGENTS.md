...
5. `.cursor/skills/lancun-design/SKILL.md`（外部工具用法：Vercel 摘表、ui-ux-pro-max 三模块）
6. `docs/DESIGN_SYSTEM.md`、`docs/PAGE_STRUCTURE.md` 等专项文档（**CSS 实现 mirror**）
7. `TASKS.md`
...
- 开发新页面前读取根目录 **`DESIGN.md`**、`.codexrules`、`PROJECT_BRIEF.md`、`PAGE_STRUCTURE.md`、`docs/DESIGN_SYSTEM.md` 和 `ACCEPTANCE.md`。
