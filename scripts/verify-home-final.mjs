...
const checks = [
  ...
  ['mobile index horizontal scroll', () => css.includes('-webkit-line-clamp: 3') && !css.includes('.ocean-index-rail')],
  ['mobile pin 40px+', () => css.includes('min-width: 2.5rem')],
  ['reduced motion hooks', () => css.includes("html[data-reduced-motion='true']")],
  ['home css v98', () => html.includes('home.css?v=98')],
  ...
  ['hero lframe strengthened', () => css.includes('border-top: 2.5px solid #fff') && css.includes('clamp(4.25rem, 11vw, 6.5rem)')],
