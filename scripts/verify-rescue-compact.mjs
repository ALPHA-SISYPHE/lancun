...
const checks = [
  ...
  ['css metric strip frost', css.includes('.monitor-metrics') && css.includes('rgba(234, 245, 247, 0.58)')],
  ['css map stage gradient', css.includes('.monitor-window::after') && css.includes('linear-gradient')],
  ...
  ['css compact ring', css.includes('.composition-card .rescue-pie__ring') && css.includes('112px')],
  ...
  ['css monitor map z2', css.includes('.monitor-map') && css.includes('z-index: 2')],
];
